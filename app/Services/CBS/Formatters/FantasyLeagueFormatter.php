...
use App\Services\CBS\Data\FantasyNFL\LineupSlotCountsData;
use App\Services\CBS\Data\FantasyNFL\ResourceLeagueData;
use App\Services\CBS\Data\FantasyNFL\ResourceTeamsData;
use App\Services\CBS\Data\FantasyNFL\RosterSettingsData;
use App\Services\CBS\Data\FantasyNFL\ScheduleData;
use App\Services\CBS\Data\FantasyNFL\SettingsSettingsData;
...
class FantasyLeagueFormatter
{
    ...
    private function formatLeagueData()
    {
        ...
        $this->data['league'] = [
            'name'        => $settings->name,
            'season'      => $this->season(),
            'slug'        => 'cbs-' . Str::slug($settings->name) . '-' . $this->season(),
            'description' => null,
    ...
    private function mapScoringSettings(Collection $scoring): array
    {
        ...
        foreach (CBSConstants::SCORING_MAP as $espnKey => $modelKey) {
