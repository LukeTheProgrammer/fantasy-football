...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/html/fantasy-football/public/storage' => 'string',
            ...
            'services.espn.sports_base_url' => 'string',
            'services.espn.site_base_url' => 'string',
            'services.espn.version' => 'string',
            'services.espn.retry_limit' => 'integer',
            'services.espn.api_year' => 'integer',
...
'hashing.rehash_on_login','concurrency.default','app.name','app.env','app.debug',
...
'auth.passwords.users.throttle','auth.password_timeout','boost.enabled','boost.browser_logs_watcher','cache.default',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/fantasy-football/public/storage','inertia.ssr.enabled','inertia.ssr.url',
...
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.espn.sports_base_url','services.espn.site_base_url',
'services.espn.version','services.espn.retry_limit','services.espn.api_year','session.driver','session.lifetime',
...
'session.secure','session.http_only','session.same_site','session.partitioned','user.default.email',
'user.default.password','user.default.name','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables',
...
'boost.browser-logs','sanctum.csrf-cookie','teams.index','teams.store',
'teams.update','teams.destroy','players.store','players.update','players.destroy',
'leagues.index','leagues.store','leagues.show','leagues.update','leagues.destroy',
'league-settings.show','league-settings.update','league-members.index','league-members.store','league-members.show',
'league-members.update','league-members.destroy','leagues.seasons.index','leagues.seasons.store','leagues.seasons.show',
'leagues.seasons.update','leagues.seasons.destroy','leagues.drafts.index',
'leagues.drafts.store','leagues.drafts.show','leagues.drafts.update','leagues.drafts.destroy','home','dashboard','leagues.index',
'leagues.create','leagues.edit','leagues.show','drafts.index','drafts.create',
'drafts.show','drafts.edit','drafts.board','drafts.results','drafts.draft-room',
...
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','DEFAULT_USER_EMAIL',
'DEFAULT_USER_PASSWORD','DEFAULT_USER_NAME','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL',
'LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION','DB_HOST',
'DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD','MYSQL_EXTRA_OPTIONS',
