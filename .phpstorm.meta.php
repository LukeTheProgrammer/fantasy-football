...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'Action' => \App\Services\Actions\ActionService::class,
            'Auction' => \App\Services\Auction\AuctionService::class,
            'CBS' => \App\Services\CBS\CBSService::class,
            'Data' => \App\Services\Data\DataService::class,
            'Espn' => \App\Services\Espn\EspnService::class,
            'FantasyPros' => \App\Services\FantasyPros\FantasyProsService::class,
            ...
            'Import' => \App\Services\Imports\ImportService::class,
            'Inertia\Ssr\Gateway' => \Inertia\Ssr\HttpGateway::class,
            'Nflverse' => \App\Services\Nflverse\NflverseService::class,
            'Player' => \App\Services\Player\PlayerService::class,
            'ProFootballReference' => \App\Services\ProFootballReference\ProFootballReferenceService::class,
            'Scraper' => \App\Services\Scrapers\ScraperService::class,
    ...
    override(\config(), map([
            ...
            'services.espn.default_s2' => 'string',
            'services.espn.default_swid' => 'string',
            'services.espn.default_league_id' => 'string',
            'services.espn.retry_limit' => 'string',
            'services.fantasy_pros.key' => 'string',
            'services.fantasy_pros.base_url' => 'string',
            'services.fantasy_pros.mcp_url' => 'string',
            ...
            'user.default.email' => 'string',
            'user.default.password' => 'string',
            'user.default.name' => 'string',
...
'view','record','update','delete','denyWithStatus',
'denyAsNotFound',);
...
'auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','boost.enabled',
'boost.rules.enabled','boost.rules.scoped_guidelines','boost.guidelines.exclude','boost.skills.exclude','boost.executable_paths.php',
'boost.executable_paths.composer','boost.executable_paths.npm','boost.executable_paths.vendor_bin','boost.executable_paths.current_directory','boost.browser_logs_watcher',
'boost.browser_log_levels','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key','broadcasting.connections.reverb.secret',
...
'filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.pages.ensure_pages_exist',
...
'inertia.devtools.redact.keys','inertia.devtools.redact.headers','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'logging.channels.daily.days','logging.channels.daily.replace_placeholders','logging.channels.monthly.driver','logging.channels.monthly.path','logging.channels.monthly.level',
'logging.channels.monthly.max_files','logging.channels.monthly.replace_placeholders','logging.channels.slack.driver','logging.channels.slack.url','logging.channels.slack.username',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.espn.default_s2','services.espn.default_swid','services.espn.default_league_id',
'services.espn.retry_limit','services.fantasy_pros.key','services.fantasy_pros.base_url','services.fantasy_pros.mcp_url','session.driver',
...
'user.default.email','user.default.password','user.default.name','mcp.redirect_domains','mcp.custom_schemes',
'mcp.authorization_server','mcp.tool_search.max_tool_calls','mcp.tool_search.max_output_bytes','reverb.default','reverb.servers.reverb.host',
...
'reverb.apps.apps.0.rate_limiting.enabled','reverb.apps.apps.0.rate_limiting.max_attempts','reverb.apps.apps.0.rate_limiting.decay_seconds','reverb.apps.apps.0.rate_limiting.terminate_on_limit','data.date_format',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'boost.browser-logs','sanctum.csrf-cookie','api.',
'api.','api.teams.index','api.teams.store','api.teams.update','api.teams.destroy',
'api.players.store','api.players.update','api.players.destroy','api.player-aliases.index','api.player-aliases.store',
'api.player-aliases.update','api.player-aliases.destroy','api.players-missing.index','api.players-missing.store','api.players-missing.update',
'api.players-missing.destroy','api.leagues.index','api.leagues.store','api.leagues.show','api.leagues.update',
'api.leagues.destroy','api.league-settings.show','api.league-settings.update','api.league-members.index','api.league-members.store',
'api.league-members.show','api.league-members.update','api.league-members.destroy','api.','api.',
'api.leagues.drafts.index','api.leagues.drafts.store','api.leagues.drafts.show','api.leagues.drafts.update','api.leagues.drafts.destroy',
'api.','home','dashboard','players.index',
'leagues.index','leagues.create','leagues.edit','leagues.show','drafts.index',
'drafts.create','drafts.show','drafts.edit','drafts.results','drafts.budgets',
'drafts.draft-room','drafts.players.show','drafts.picks.store','drafts.sync.store','drafts.sync.destroy',
'drafts.budget.update','drafts.picks.update','drafts.picks.destroy','rankings.index',
...
'verification.verify','verification.send','password.confirm','logout','storage.local','storage.local.upload',);
...
'DEFAULT_USER_EMAIL','DEFAULT_USER_PASSWORD','DEFAULT_USER_NAME','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS',
'LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION',
'DB_HOST','DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD',
'MYSQL_EXTRA_OPTIONS','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','VITE_CONFIG_NATIVE_IGNORE_WARNING',
'DEFAULT_USER_EMAIL','DEFAULT_USER_PASSWORD','DEFAULT_USER_NAME','ESPN_DEFAULT_S2','ESPN_DEFAULT_SWID',
'ESPN_DEFAULT_LEAGUE_ID','ESPN_RETRY_LIMIT','FP_KEY',);
