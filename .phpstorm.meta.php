...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/matthewmoore/code/fantasy-football/public/storage' => 'string',
...
'filesystems.links./Users/matthewmoore/code/fantasy-football/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist','inertia.page_paths',
...
'session.same_site','session.partitioned','boost.enabled','boost.browser_logs_watcher','ide-helper.filename',
...
'boost.browser-logs','sanctum.csrf-cookie','teams.index','teams.show','players.index',
'players.show','teams.store','teams.update',
'teams.destroy','players.store','players.update','players.destroy',
