...
'view','update','delete','denyWithStatus','denyAsNotFound',);
...
'services.espn.retry_limit','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'session.same_site','session.partitioned','user.default.email','user.default.password','user.default.name',
'mcp.redirect_domains','mcp.custom_schemes','mcp.authorization_server','mcp.tool_search.max_tool_calls','mcp.tool_search.max_output_bytes',
...
'api.','api.','home','dashboard',
'players.index','leagues.index','leagues.create','leagues.edit','leagues.show',
'drafts.index','drafts.create','drafts.show','drafts.edit','drafts.board',
'drafts.results','drafts.draft-room','rankings.index','profile.edit',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','DEFAULT_USER_EMAIL',
'DEFAULT_USER_PASSWORD','DEFAULT_USER_NAME','ESPN_DEFAULT_S2','ESPN_DEFAULT_SWID','ESPN_DEFAULT_LEAGUE_ID',
'ESPN_RETRY_LIMIT',);
