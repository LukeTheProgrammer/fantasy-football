...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/luke/Dev/fantasy-football/public/storage' => 'string',
...
'filesystems.links./home/luke/Dev/fantasy-football/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist','inertia.page_paths',
...
'boost.enabled','boost.browser_logs_watcher','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'boost.browser-logs','sanctum.csrf-cookie','players.index','players.show','teams.index','teams.store','teams.update','teams.destroy',
'players.store','players.update','players.destroy','home',
