...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('league_settings', function (Blueprint $table) {
            ...
            // Scoring settings
            $table->decimal('passing_points_per_yard', 8, 2)->default(0.04); // 1 point per 25 yards
            $table->decimal('passing_td_points', 8, 2)->default(4.0);
            $table->decimal('interception_points', 8, 2)->default(-2.0);
            $table->decimal('rushing_points_per_yard', 8, 2)->default(0.1); // 1 point per 10 yards
            $table->decimal('rushing_td_points', 8, 2)->default(6.0);
            $table->decimal('receiving_points_per_yard', 8, 2)->default(0.1); // 1 point per 10 yards
